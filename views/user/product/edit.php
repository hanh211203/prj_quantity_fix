      ...
      ?>
        ...
        <div class="box1 col-lg-6"> 
            <div class="mb-3">
                ...
                <input type="text" id="prd_name" name="prd_name" class="form-control" value="<?= $item['prd_name']?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="weight" name="weight" class="form-control" value="<?= $item['weight']?>">
            </div> 
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input  name="image" id="price" type="file" onchange="preview()">
                <br>
                <div>
        ...
        <div class="box1 col-lg-6">
            ...
            <div class="mb-3">
                ...
                <textarea name="uses" id="uses" cols="30" row="20"><?= $item['uses']?></textarea>
            </div>
            <div class="mb-3">
                <label for="recommended_use" class="form-label"><b>Recommended_use</b></label>
                <textarea name="recommended_use" id="recommended_use" cols="30" row="20" ><?= $item['recommended_use']?></textarea>
            </div>
            <div class="mb-3">
                <label for="expiry" class="form-label"><b>Expiry</b></label>
                <input type="text" id="expiry" name="expiry" class="form-control" value="<?= $item['expiry']?>">
            </div>
            <div class="mb-3">
