<?php
	...
	if(isset($_GET['item'])){
		$item = $_GET['item'];
		$sql = $mysqli->query("SELECT * FROM product WHERE prd_name LIKE '%$item%'");
	}
							...
							<div class="image-wrapper">
								<div class="image">
									<div class="overlay">
										<div class="position">
											<div>
												<p><?php echo $obj->prd_name ?></p>
												<a href="item.php?id=<?php echo $obj->prd_id?>" class="quickshop1 ">Quick shop</a>
											</div>
										</div>
									</div>
									<a href="item.php?id=<?php echo $obj->prd_id?>"><img src="images/photos/image-<?php echo $obj->prd_id?>.PNG" style="margin: -27.5px 0 0 0;" alt="" /></a>
								</div>
							</div>
							<h2><a href="item.php?id=<?php echo $obj->prd_id?>"><?php echo $obj->prd_name?></a></h2>
